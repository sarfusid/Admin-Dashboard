...
// class FormsElements extends React.Component {
    ...
    const FormsElements = () => {
            ...
            // const attenCollection = await db.collection("ateen").doc(ateenId).set({
            //     ateenId:ateenId,
            //     location:location.description,
            //     zipcode:location.pincode,
            //     distpins:selectedPincode,
            //     latlng:location.latlng,
                
            // }).then(()=>{
            //     counterDoc.exists ? stateRef.update({counter : counter+1}):stateRef.set({counter:counter+1})
            // })
        
         
//     const ProId = db.collection('Suzuki').doc('pd006');
//     ProId.set({
//         id:'pd006'
//     });
// const id= db.collection('Suzuki').doc('pd006');
// id.update({
//     id:fire.firestore.FieldValue.increment()
// });
    const [handleComp, setHandleComp] = useState({})

    const onChange = e => setHandleComp({...handleComp, [e.target.name]: e.target.value})
    const {id, dprice2, dprice1, mrp2, mrp1, particulars, screen_size} = handleComp
    
    const handleSubmit = async(e) =>{
        e.preventDefault();
        const statsRef = await db.collection("Suzuki").doc("--stats--");
        ...
        db.collection('Suzuki').doc(ateenId).set({
            id:ateenId,
            ...
            <Aux>
                <Row>
                    <Col>
                        <Card>
                            <Card.Header>
                                <Card.Title as="h5">Suzuki</Card.Title>
                            </Card.Header>
                            <Card.Body>
                                        ...
                                        <Form>
                                            {/* <Form.Group controlId="formBasicEmail">
                                                ...
                                                {/* <Form.Text className="text-muted">
                                                    We'll never share your Product Id with anyone else.
                                                </Form.Text> */}
                                            {/* <Form></Form.Group> */} 
...
//                                         <Form.Group controlId="exampleForm.ControlInput1">
//                                             <Form.Label>1 + 16 GB</Form.Label>
//                                             <Form.Control type="number" placeholder="MRP"  name ="mrp2"/><br></br>
//                                             <Form.Control type="number" placeholder="D.Price" name ="dprice2" />
//                                         </Form.Group>
//                                             <Form.Group controlId="exampleForm.ControlInput1">
//                                             <Form.Label>2 + 16 GB</Form.Label>
//                                             <Form.Control type="number" placeholder="MRP" name ="mrp1" /><br></br>
//                                             <Form.Control type="number" placeholder="D.Price" name ="dprice1" />
//                                         </Form.Group>
